							...
							<div class="col-md-9 custom-control custom-checkbox">
								...
								<div class="form-check form-check-inline">
									<input type="checkbox"
										...
										class="form-check-label custom-control-label" for="sports">운동</label>
								</div>
								...
								<div class="form-check form-check-inline">
									<input type="checkbox"
										...
										class="form-check-label custom-control-label" for="movie">영화</label>
								</div>
								...
								<div class="form-check form-check-inline">
									<input type="checkbox"
										...
										class="form-check-label custom-control-label" for="music">음악</label>
								</div>
								<br>
								...
								<div class="form-check form-check-inline">
									<input type="checkbox"
										...
										class="form-check-label custom-control-label" for="game">게임</label>
								</div>
