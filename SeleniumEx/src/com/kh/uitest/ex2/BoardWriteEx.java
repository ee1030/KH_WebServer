...
public class BoardWriteEx {
	...
	public static void main(String[] args) {
		...
		// ** alert 창으로 포커스를 옮겨 확인버튼 누르기
		driver.switchTo().alert().accept();
		
		// 테스트 종료(필수) 확인을 위해 주석처리
		// driver.close();
	}
