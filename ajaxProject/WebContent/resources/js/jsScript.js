...
jsBtn1.addEventListener("click", function() {
    ...
    // 2) onreadystatechange : Ajax 통신이 성공한 경우에 대한 동작 지정
    ...
    xhr.open("GET", "jsAjax1.do?name=고길동&age=45", true);
...
jsBtn2.addEventListener("click", function() {
    ...
    xhr.send("pname=노트북&price=1000000");
